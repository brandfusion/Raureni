	...
	var getDefaultSettings = function() {
		...
		return {
			...
			clusterer: {
				...
				averageCenter: true, // (boolean) Wether the center of each cluster should be the average of all markers in the cluster.
	...
	Dynamicweb.Map = function(options) {
		...
		initSearch = function() {
			...
			if (searchForm) {
				...
				searchQueryField = getElementByName('select', searchForm, function(el) {
					return el.name == 'adr';
				});
				searchRadiusField = getElementByName('select', searchForm, function(el) {
					return el.name == 'dst';
				});
